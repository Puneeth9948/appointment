...
public class Controller {
    ...
    private final String PATIENT_SERVICE_URL = "https://patient6299-ebc2bbdqb4cmc0hh.eastus2-01.azurewebsites.net//patient/";
    private final String DOCTOR_SERVICE_URL = "https://doctor6299-atgff7d0dddwaka4.eastus2-01.azurewebsites.net//doctor/";
    @PostMapping ("/add")
